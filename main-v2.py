...
def process_images(input_image_path, output_image_path, object_folder, process_folder, phase_folder, num_phases):
...
process_images(input_image_path, output_image_path, object_folder, process_folder, phase_folder, num_phases=3)
