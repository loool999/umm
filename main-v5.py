    ...
    for phase in range(num_phases):
        ...
        for _ in range(iterations):
            ...
            if score > last_similarity_score:
                ...
                print(f"New best image saved with similarity score: {score:.20f}%")
            else:
                os.remove(output_v1_image_path)
                print(f"Discarded image with similarity score: {score:.20f}%")
...
process_images(input_image_path, "filled.jpg", object_folder, process_folder, phase_folder, num_phases=100, iterations=40)
